  ...
  //blurHandler(0);
    ...
    while(cvWaitKey(1) == -1) {
        ...
        if(frame) {
            ...
            cvCanny(frameBblur, frameBedge, edgeThreshB, edgeThreshB*ratio);
            ...
            frameTmp=cvCreateImage(cvGetSize(frameBedge),frameBedge->depth,1);
            //frameTmp = 

#endif

#ifdef AUTO_ADJUST_THRESH
            // count the white
            ...
            if(     houghThreshold < minHoughThreshold)
                    houghThreshold = minHoughThreshold;
