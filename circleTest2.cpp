...
void houghCircleHandler(int){
    ...
    printf("start of houghCircleHandler\n");
    ...
    printf("end of houghCircleHandler\n");
...
void drawHoughCircles(int){
    ...
    printf("end of drawHoughCircles\n");
}
